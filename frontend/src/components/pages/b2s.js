...
export default function Page1() {
  return (
    <>
      ...
      <h2 className="head1" align="center">บทที่ 1 Basic Computing</h2>
        <p><label class="w3-text-dark-gray"><b>แปลงเลขฐาน 2 โดยใช้ IEEE single precision format</b></label> </p>
